...
*/
  ...
  class_<Micropolis>("Micropolis")
    ...
    .property("initSimLoad", &Micropolis::initSimLoad)
    .property("simLoops", &Micropolis::simLoops)
    ...
    .property("simPausedSpeed", &Micropolis::simPausedSpeed)
    .property("simPasses", &Micropolis::simPasses)
    .property("simPass", &Micropolis::simPass)
    .property("gameLevel", &Micropolis::gameLevel)
    .property("scenario", &Micropolis::scenario)
    .property("doAnimation", &Micropolis::doAnimation)
    .property("graph10Max", &Micropolis::graph10Max)
    .property("graph120Max", &Micropolis::graph120Max)
    ...
    .property("donDither", &Micropolis::donDither)
    .property("totalFunds", &Micropolis::totalFunds)
    .property("cityCenterX", &Micropolis::cityCenterX)
    .property("cityCenterY", &Micropolis::cityCenterY)
    .property("pollutionMaxX", &Micropolis::pollutionMaxX)
    .property("pollutionMaxY", &Micropolis::pollutionMaxY)
    .property("crimeMaxX", &Micropolis::crimeMaxX)
    .property("crimeMaxY", &Micropolis::crimeMaxY)
    ...
    .property("valveFlag", &Micropolis::valveFlag)
    .property("crimeRamp", &Micropolis::crimeRamp)
    .property("pollutionRamp", &Micropolis::pollutionRamp)
    .property("resCap", &Micropolis::resCap)
    .property("indCap", &Micropolis::indCap)
    .property("comCap", &Micropolis::comCap)
    .property("resValve", &Micropolis::resValve)
    .property("indValve", &Micropolis::indValve)
    .property("comValve", &Micropolis::comValve)
    .property("disasterEvent", &Micropolis::disasterEvent)
    .property("disasterWait", &Micropolis::disasterWait)
    .property("scoreType", &Micropolis::scoreType)
    .property("scoreWait", &Micropolis::scoreWait)
    .property("poweredZoneCount", &Micropolis::poweredZoneCount)
    .property("unpoweredZoneCount", &Micropolis::unpoweredZoneCount)
    .property("newPower", &Micropolis::newPower)
    .property("simCycle", &Micropolis::simCycle)
    .property("phaseCycle", &Micropolis::phaseCycle)
    .property("speedCycle", &Micropolis::speedCycle)
    .property("doInitialEval", &Micropolis::doInitialEval)
    .property("mapSerial", &Micropolis::mapSerial)
    ...
    .property("externalMarket", &Micropolis::externalMarket)
    .property("cityTax", &Micropolis::cityTax)
    .property("cityTaxAverage", &Micropolis::cityTaxAverage)
    ...
    .property("messageNumber", &Micropolis::messageNumber)
    .property("messageTimeLast", &Micropolis::messageTimeLast)
    .property("evalChanged", &Micropolis::evalChanged)

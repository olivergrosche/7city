...
declare namespace RuntimeExports {
    ...
    namespace FS {
        ...
        export let mounts: never[];
        export let devices: {};
        export let streams: never[];
        export let nextInode: number;
        export let nameTable: null;
        export let currentPath: string;
        export let initialized: boolean;
        export let ignorePermissions: boolean;
        export let filesystems: null;
        ...
        export function forceLoadFile(obj: any): true | undefined;
...
export interface Position extends ClassHandle {
  posX: number;
  posY: number;
...
export interface ToolEffects extends ClassHandle {
  clear(): void;
  modifyWorld(): void;
...
export interface MapByte1 extends ClassHandle {
...
export interface MapByte2 extends ClassHandle {
  readonly MAP_BLOCKSIZE: number;
  readonly MAP_W: number;
  readonly MAP_H: number;
  fill(_0: number): void;
...
export interface MapByte4 extends ClassHandle {
  readonly MAP_BLOCKSIZE: number;
  readonly MAP_W: number;
  readonly MAP_H: number;
  fill(_0: number): void;
...
export interface MapShort8 extends ClassHandle {
  readonly MAP_BLOCKSIZE: number;
  readonly MAP_W: number;
  readonly MAP_H: number;
  fill(_0: number): void;
...
export interface SimSprite extends ClassHandle {
  get name(): string;
...
export interface Callback extends ClassHandle {
  autoGoto(_0: Micropolis | null, _1: any, _2: number, _3: number, _4: EmbindString): void;
  didGenerateMap(_0: Micropolis | null, _1: any, _2: number): void;
  didLoadCity(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  didLoadScenario(_0: Micropolis | null, _1: any, _2: EmbindString, _3: EmbindString): void;
  didLoseGame(_0: Micropolis | null, _1: any): void;
  didSaveCity(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  didTool(_0: Micropolis | null, _1: any, _2: EmbindString, _3: number, _4: number): void;
  didWinGame(_0: Micropolis | null, _1: any): void;
  didntLoadCity(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  didntSaveCity(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  makeSound(_0: Micropolis | null, _1: any, _2: EmbindString, _3: EmbindString, _4: number, _5: number): void;
  newGame(_0: Micropolis | null, _1: any): void;
  saveCityAs(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  sendMessage(_0: Micropolis | null, _1: any, _2: number, _3: number, _4: number, _5: boolean, _6: boolean): void;
  showBudgetAndWait(_0: Micropolis | null, _1: any): void;
  showZoneStatus(_0: Micropolis | null, _1: any, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number, _8: number, _9: number): void;
  simulateRobots(_0: Micropolis | null, _1: any): void;
  simulateChurch(_0: Micropolis | null, _1: any, _2: number, _3: number, _4: number): void;
  startEarthquake(_0: Micropolis | null, _1: any, _2: number): void;
  startGame(_0: Micropolis | null, _1: any): void;
  startScenario(_0: Micropolis | null, _1: any, _2: number): void;
  updateBudget(_0: Micropolis | null, _1: any): void;
  updateCityName(_0: Micropolis | null, _1: any, _2: EmbindString): void;
  updateDate(_0: Micropolis | null, _1: any, _2: number, _3: number): void;
  updateDemand(_0: Micropolis | null, _1: any, _2: number, _3: number, _4: number): void;
  updateEvaluation(_0: Micropolis | null, _1: any): void;
  updateFunds(_0: Micropolis | null, _1: any, _2: number): void;
  updateGameLevel(_0: Micropolis | null, _1: any, _2: number): void;
  updateHistory(_0: Micropolis | null, _1: any): void;
  updateMap(_0: Micropolis | null, _1: any): void;
  updateOptions(_0: Micropolis | null, _1: any): void;
  updatePasses(_0: Micropolis | null, _1: any, _2: number): void;
  updatePaused(_0: Micropolis | null, _1: any, _2: boolean): void;
  updateSpeed(_0: Micropolis | null, _1: any, _2: number): void;
  updateTaxRate(_0: Micropolis | null, _1: any, _2: number): void;
}

export interface JSCallback extends Callback {
}

export interface Micropolis extends ClassHandle {
  initSimLoad: number;
  simLoops: number;
  simSpeed: number;
  simSpeedMeta: number;
  ...
  messageTimeLast: number;
  evalChanged: boolean;
  get cityFileName(): string;
  set cityFileName(value: EmbindString);
  get cityName(): string;
  set cityName(value: EmbindString);
  setCallback(_0: Callback | null, _1: any): void;
  init(): void;
  loadCity(_0: EmbindString): boolean;
  loadScenario(_0: Scenario): void;
  saveCity(): void;
  saveCityAs(_0: EmbindString): void;
  generateSomeCity(_0: number): void;
  setGameLevelFunds(_0: GameLevel): void;
  getPopulationDensityAt(_0: number, _1: number): number;
  getRateOfGrowthAt(_0: number, _1: number): number;
  getTrafficDensityAt(_0: number, _1: number): number;
  getPollutionAt(_0: number, _1: number): number;
  getCrimeAt(_0: number, _1: number): number;
  getLandValueAt(_0: number, _1: number): number;
  getPowerGridAt(_0: number, _1: number): number;
  getPoliceCoverageAt(_0: number, _1: number): number;
  getFireCoverageAt(_0: number, _1: number): number;
  simTick(): void;
  simUpdate(): void;
  ...
  setCityName(_0: EmbindString): void;
  ...
  makeSound(_0: EmbindString, _1: EmbindString, _2: number, _3: number): void;
}
...
interface EmbindModule {
  ...
  Position: {
    new(): Position;
    new(_0: number, _1: number): Position;
  };
  ...
  MapByte1: {
    new(_0: number): MapByte1;
  };
  MapByte2: {
    new(_0: number): MapByte2;
  };
  MapByte4: {
    new(_0: number): MapByte4;
  };
  MapShort8: {
    new(_0: number): MapShort8;
  };
